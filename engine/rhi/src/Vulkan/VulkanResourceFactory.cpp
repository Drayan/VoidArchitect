...
#include <VoidArchitect/Engine/Client/Systems/ShaderSystem.hpp>
...
namespace VoidArchitect::Platform
{
    ...
    VulkanResourceFactory::CreateColorBlendState(
        const Resources::RenderStateConfig& stateConfig) const
    {
    ...
    VulkanResourceFactory::GetVertexInputDesc(const Resources::RenderStateConfig& stateConfig) const
    {
        uint32_t offset = 0;
