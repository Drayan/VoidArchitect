...
#include <VoidArchitect/Engine/Client/Systems/RenderPassSystem.hpp>
#include <VoidArchitect/Engine/Client/Systems/RenderStateSystem.hpp>
#include <VoidArchitect/Engine/Client/Systems/MeshSystem.hpp>
...
namespace VoidArchitect::Platform
{
    ...
    void VulkanExecutionContext::BindRenderState(Resources::RenderStateHandle stateHandle)
    {
