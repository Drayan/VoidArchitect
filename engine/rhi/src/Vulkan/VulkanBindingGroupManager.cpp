...
#include <VoidArchitect/Engine/Client/Systems/MaterialSystem.hpp>
#include <VoidArchitect/Engine/Client/Systems/TextureSystem.hpp>
...
namespace VoidArchitect::Platform
{
    ...
    VkDescriptorSetLayout VulkanBindingGroupManager::GetLayoutFor(
        const Resources::RenderStateConfig& stateConfig)
    {
    ...
    void VulkanBindingGroupManager::BindMaterialGroup(
        ...
        Resources::RenderStateHandle stateHandle)
    {
