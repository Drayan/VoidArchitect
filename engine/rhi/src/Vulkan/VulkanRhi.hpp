...
namespace VoidArchitect::Platform
{
    ...
    public:
        ...
        void BindRenderState(Resources::RenderStateHandle stateHandle) override;
        void BindMaterial(
            MaterialHandle materialHandle,
            Resources::RenderStateHandle stateHandle) override;
        ...
        Resources::IRenderState* CreateRenderState(
            ...
            Resources::RenderPassHandle passHandle) override;
    ...
    private:
        ...
        std::unique_ptr<RHI::ISurfaceFactory> m_SurfaceFactory;
        RHI::SurfaceHandle m_SurfaceHandle;
        RHI::SurfaceCreationCallback m_SurfaceCallback;
