...
namespace VoidArchitect::Resources
{
    ...
    {
        return colorAttachmentFormats == other.colorAttachmentFormats && depthAttachmentFormat ==
            other.depthAttachmentFormat;
    }
    ...
    size_t RenderPassSignature::GetHash() const
    {
        ...
        if (depthAttachmentFormat.has_value()) HashCombine(seed, depthAttachmentFormat.value());
