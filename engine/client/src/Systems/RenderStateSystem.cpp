...
namespace VoidArchitect
{
    ...
    void RenderStateSystem::RegisterPermutation(const Resources::RenderStateConfig& config)
    {
    ...
    Resources::RenderStateHandle RenderStateSystem::GetHandleFor(
        ...
        const Resources::RenderPassHandle passHandle)
    {
        ...
        if (!m_ConfigMap.contains(lookupKey))
        {
            ...
            return Resources::InvalidRenderStateHandle;
        }
    ...
    Resources::IRenderState* RenderStateSystem::GetPointerFor(
        const Resources::RenderStateHandle handle)
    {
        return m_RenderStates[handle].renderStatePtr;
    }

    const Resources::RenderStateConfig& RenderStateSystem::GetConfigFor(
        const Resources::RenderStateHandle handle)
    {
    ...
    {
        auto renderStateConfig = Resources::RenderStateConfig{};
        ...
        // UI RenderState
        auto uiRenderStateConfig = Resources::RenderStateConfig{};
    ...
    Resources::RenderStateHandle RenderStateSystem::GetFreeRenderStateHandle()
    {
    ...
    size_t Resources::RenderStateConfig::GetBindingsHash() const
    {
        size_t seed = 0;
