  ...
  std::string VulkanGetResultString(const VkResult result, const bool extended)
  {
    switch (result)
    {
      ...
      case VK_ERROR_OUT_OF_HOST_MEMORY:
        return extended ? "VK_ERROR_OUT_OF_HOST_MEMORY" : "A host memory allocation has failed.";
      ...
      case VK_ERROR_DEVICE_LOST:
        return extended ? "VK_ERROR_DEVICE_LOST" : "The logical or physical device has been lost.";
      case VK_ERROR_MEMORY_MAP_FAILED:
        return extended ? "VK_ERROR_MEMORY_MAP_FAILED" : "Mapping of a memory object has failed.";
      ...
      case VK_ERROR_FEATURE_NOT_PRESENT:
        return extended ? "VK_ERROR_FEATURE_NOT_PRESENT" : "A requested feature is not supported.";
      ...
      case VK_ERROR_OUT_OF_POOL_MEMORY:
        return extended ? "VK_ERROR_OUT_OF_POOL_MEMORY" : "A pool memory allocation has failed.";
      // Provided by VK_VERSION_1_1
      ...
      case VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS:
        return extended
                 ...
                 : "An opaque capture address is not a valid pointer for the specified device.";
      // Provided by VK_VERSION_1_3
      case VK_PIPELINE_COMPILE_REQUIRED:
        return extended
                 ? "VK_PIPELINE_COMPILE_REQUIRED"
                 : "A pipeline creation or update will fail due to a pipeline compile required for a pipeline config that was not specified at pipeline creation.";
      // Provided by VK_VERSION_1_4
      case VK_ERROR_NOT_PERMITTED:
        return extended
                 ? "VK_ERROR_NOT_PERMITTED"
                 : "The requested operation is not permitted for the current device state.";
      ...
      case VK_ERROR_VALIDATION_FAILED_EXT:
        return extended ? "VK_ERROR_VALIDATION_FAILED_EXT" : "A validation layer found an error.";
      ...
      case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
        return extended
                 ...
                 : "The display is in full-screen exclusive mode and cannot present to it.";
      ...
      case VK_OPERATION_NOT_DEFERRED_KHR:
        return extended ? "VK_OPERATION_NOT_DEFERRED_KHR" : "The operation is not deferred.";
      ...
      case VK_ERROR_COMPRESSION_EXHAUSTED_EXT:
        return extended
                 ...
                 : "The compression operation has exhausted the available compression resources.";
      ...
      case VK_PIPELINE_BINARY_MISSING_KHR:
        return extended ? "VK_PIPELINE_BINARY_MISSING_KHR" : "The pipeline binary is missing.";
      // Provided by VK_KHR_pipeline_binary
      case VK_ERROR_NOT_ENOUGH_SPACE_KHR:
        return extended ? "VK_ERROR_NOT_ENOUGH_SPACE_KHR" : "The pipeline binary is too large.";
    }
  }
